...
public class VideoIOVLC {
     ...
     */
    public static KeyFrameCollection readVideo (File video) {
     ...
     */
    public static KeyFrameCollection readFolder (File... co) {
     ...
     */
    public static void addImage(BufferedImage img, KeyFrameCollection coll) {
     ...
     * @param coll collection to be added
     */
    private static void addItem(File file, KeyFrameCollection coll) {
